...
subprocess.Popen("./build/modul_tls tls_server --test_main_dir=" +
        config.cpt_dir_rel_to_mod_tls_cwd + " --test_case=" + test_case + " --port=4450 --result_dir=misc/run/mod_browser_test_results --stay", shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, cwd=mod_tls_cwd);
